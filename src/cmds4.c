#ident "@(#) TREK73 $Header: /home/ncvs/trek73/src/cmds4.c,v 1.2 1999/10/26 20:12:58 dillon Exp $"
/*
 * $Source: /home/ncvs/trek73/src/cmds4.c,v $
 *
 * $Header: /home/ncvs/trek73/src/cmds4.c,v 1.2 1999/10/26 20:12:58 dillon Exp $
 *
 * $Log: cmds4.c,v $
...
Prototype int alterpntparams(struct ship *sp);
Prototype int play_dead(struct ship *sp);
Prototype int corbomite_bluff(struct ship *sp);
Prototype int surrender_ship(struct ship *sp);
Prototype int request_surrender(struct ship *sp);
Prototype int self_destruct(struct ship *sp);
Prototype int abort_self_destruct(struct ship *sp);

int
alterpntparams(struct ship *sp)
{
	int temp;
	char buf1[30];
...
int
corbomite_bluff(struct ship *sp)
{
...
int
request_surrender(struct ship *sp)
{
...
int
abort_self_destruct(struct ship *sp)
{
	printf("%s:   Computer, this is Captain %s of the U.S.S. %s.\n",
	    captain, captain, sp->name);
