#ident "@(#) TREK73 $Header: /home/ncvs/trek73/src/init.c,v 1.2 1999/10/26 20:12:59 dillon Exp $"
/*
 * $Source: /home/ncvs/trek73/src/init.c,v $
 *
 * $Header: /home/ncvs/trek73/src/init.c,v 1.2 1999/10/26 20:12:59 dillon Exp $
 *
 * $Log: init.c,v $
...
Prototype void name_crew(void);
Prototype void init_ships(void);
Prototype struct ship_stat *read_class(char *str, int flag);
...
init_ships(void)
{
	struct ship_stat *my_class, *his_class;
