#ident "@(#) TREK73 $Header: /home/ncvs/trek73/src/damage.c,v 1.3 1999/10/26 20:21:59 dillon Exp $"
/*
 * $Source: /home/ncvs/trek73/src/damage.c,v $
 *
 * $Header: /home/ncvs/trek73/src/damage.c,v 1.3 1999/10/26 20:21:59 dillon Exp $
 *
 * $Log: damage.c,v $
...
Prototype int damage(int hit, struct ship *ep, int s, struct damage *dam, int flag);

void check_locks(struct ship *ep, int percent, struct ship *fed);
