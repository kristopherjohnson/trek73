#ident "@(#) TREK73 $Header: /home/ncvs/trek73/src/cmds1.c,v 1.2 1999/10/26 20:12:57 dillon Exp $"
/*
 * $Source: /home/ncvs/trek73/src/cmds1.c,v $
 *
 * $Header: /home/ncvs/trek73/src/cmds1.c,v 1.2 1999/10/26 20:12:57 dillon Exp $
 *
 * $Log: cmds1.c,v $
...
Prototype int fire_phasers(struct ship *sp);
Prototype int fire_tubes(struct ship *sp);
Prototype int lock_phasers(struct ship *sp);
Prototype int lock_tubes(struct ship *sp);
Prototype int turn_phasers(struct ship *sp);
Prototype int turn_tubes(struct ship *sp);
Prototype int load_tubes(struct ship *sp);
Prototype int launch_probe(struct ship *sp);
Prototype int probe_control(struct ship *sp);

int
fire_phasers(struct ship *sp) 
{
	char	buf1[20];
	char	buf2[20];
	char	c;
